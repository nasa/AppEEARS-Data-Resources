...
+ Earthdata Login Authentication is required to access AppEEARS API and AppEEARS outputs directly from an Amazon AWS bucket. If you do not have an account, create an account [here](https://urs.earthdata.nasa.gov/users/new).
---
...
| **[Streaming_AppEEARS_Area_Outputs_and_Perform_Analysis.ipynb](https://github.com/nasa/AppEEARS-Data-Resources/blob/main/Python/tutorials/Streaming_AppEEARS_Area_Outputs_and_Perform_Analysis.ipynb)** | Jupyter Notebook | Demonstrates how how to stream AppEEARS outputs without cloud access from several data products into a Jupyter Notebook and perform analysis
